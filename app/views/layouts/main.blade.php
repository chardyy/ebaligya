...
<div id="wrapper">
    <header>
        ...
        <section id="action-bar">
            <div id="logo">
                <a href="/"><span id="logo-accent">e</span>Baligya</a>
            </div><!-- end logo -->
    ...
    <footer>
        <section id="contact">
            <h3>You<br>can also email us at <a href="mailto:rborofeo@gmail.com">rborofeo@gmail.com</a></h3>
        </section><!-- end contact -->
        ...
        <section class="clearfix">
            <div id="copyright">
                ...
                <p id="store-desc">This is our project for Software Engineering.</p>
                <p id="store-copy">&copy; 2015 eBaligya.</p>
            </div><!-- end copyright -->
            <div id="connect">
